...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "A collection of all the projects I&#39;ve worked to.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Teaching",
          description: "Materials for courses and thesis projects for students.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-are-thrilled-to-announce-that-both-our-papers-evaluating-portable-programming-models-for-hypergraph-label-propagation-on-gpus-and-optimizing-the-ligen-drug-discovery-pipeline-for-intel-max-gpus-have-been-accepted-to-the-proceedings-of-the-pdp2026-conference-that-will-be-held-in-romania-this-year",
          title: 'We are thrilled to announce that both our papers “Evaluating Portable Programming Models...',
          description: "",
